...
public class Question6 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Question 6");

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel3.setText("What grille design has become a defining feature of BMW automobiles?");

        btnGroup1.add(jrbtn1);
        jrbtn1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jrbtn1.setText("Heart grille");
    ...
    private void btncheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncheckAnswerActionPerformed
       ...
       if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected()){
           ...
           if(jrbtn4.isSelected()){
               ...
               lblAnswerStatus.setText("Incorrect answer - the Answer is  : Kidney grille");
    ...
    private void btnSubmitAndNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitAndNextActionPerformed
         if (!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected()) {
            ...
            new Question7(quizanswerd, marks).setVisible(true);
            this.dispose();
        }
