...
public class Question1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("What do the letters in BMW stand for ?");

        btnGroup1.add(jrbtn1);
        jrbtn1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jrbtn1.setText("Bayerische Motoren Werke");
        ...
        jrbtn4.setText("Berlin Maritime World");
    ...
    private void btncheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncheckAnswerActionPerformed
        ...
        if (!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected()) {
            ...
            if (jrbtn1.isSelected()) {
                ...
                lblAnswerStatus.setText("Incorrect answer - the Answer is  : Bayerische Motoren Werke");
