...
public class Question7 extends javax.swing.JFrame {
     ...
     */
    public Question7(int questionAnswered, int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Question 7");

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel3.setText("Which BMW featured vertically sliding doors?");
    ...
    private void btncheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncheckAnswerActionPerformed
       ...
       if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected()){
           ...
           if(jrbtn1.isSelected()){
               ...
               lblAnswerStatus.setText("Incorrect answer - the Answer is  : Z1");
    ...
    private void btnSubmitAndNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitAndNextActionPerformed
        if (!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected()) {
            ...
            new Question8(quizanswerd, marks).setVisible(true);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Question7(0,0).setVisible(true);
            }
        });
    }
